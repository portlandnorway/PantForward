...
puts 'Creating a fake test user: Francis Johansson-Merric'
puts 'user: francismerric@gmail.com'
puts 'password: password'

1.times do
  user = User.new(
    email: 'francismerric@gmail.com',
    first_name: 'Francis',
    last_name: 'Johansson-Merric',
    phone_number: '91884522',
    password: 'password'
  )
  file = URI.open('https://images.unsplash.com/photo-1514501259756-f4b6fbeffa67?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60')
...
puts 'Sorry, but we have to create 10 new collections... here we go!'
...
SMALL_BOTTLES = [10, 15, 20, 25, 20, 25, 20, 30, 50, 100, 10, 30, 15, 20, 20, 25, 25, 10, 20]
...
10.times do
  ...
  puts "user sample array, count: #{pineapple.count}"
  collection.save!
end

puts "OK, now we're done."
puts "Thanks for waiting."
puts "Hey, we're pretty great seeds aren't we?"
sleep(1)
puts "Well, I think so anyway..."
sleep(1)
puts "By the way, you heard about this Get A Tractor App?"
sleep(1)
puts 'Supposed to be insane.'
